        ...
        <ul class="nav navbar-nav">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
	            	              <li><a href="<c:url value='/node/form'/>"><span class="glyphicon glyphicon-plus-sign"></span> Add node</a></li>	              
	              <li><a href="<c:url value='/node'/>"><span class="glyphicon glyphicon-menu-hamburger"></span> List node</a></li>
